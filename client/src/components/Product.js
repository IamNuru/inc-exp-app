...
const Product = (props) => {
	...
	return (
		<tr
			className={
				(type === "inc" ? "bg-purple-300" : "bg-pink-300") +
				" bb-4 leading-8 p-2"
			}
		>
			<td
				className={
					"pl-2 " + (type === "inc" ? "text-purple-700" : "text-pink-700")
				}
			>
			...
			<td className="text-center">
				<ul className="flex ml-auto">
					<li
						className="px-1 text-purple-700 mouse-hover"
						onClick={() => setCurrent(props.product)}
					>
